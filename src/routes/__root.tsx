...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Upskill Educational Initiative" },
      { property: "og:title", content: "Upskill Educational Initiative" },
      {
        property: "og:description",
        content: "Train a Teacher, Change the World — innovative teacher training, research, and advocacy across Africa.",
      },
